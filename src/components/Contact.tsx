      ...
      <div className="w-full max-w-7xl pt-6">
        <div className="relative mx-4 border-b border-white/10">
          ...
          <RoundedButton
            ...
            className="absolute right-4 top-[50%] flex w-[6.5rem] cursor-pointer items-center justify-center rounded-full bg-slate-600/75 px-4 py-7 text-white outline-none outline outline-2  outline-offset-2 hover:outline-blue-500 md:right-40"
          >
        ...
        <div className="m-12 flex flex-col gap-5 pt-4 md:flex-row">
          <RoundedButton
            ...
            className="flex h-0 cursor-pointer items-center justify-center rounded-3xl bg-slate-600/75 px-4 py-6 text-white outline-none outline outline-2  outline-offset-2 hover:outline-blue-500 md:right-40"
          >
            <p className="relative z-[2] m-0 text-center font-semibold">
              ocelloid@gmail.com
            </p>
